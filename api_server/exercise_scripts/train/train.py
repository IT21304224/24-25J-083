...
df = describe_dataset("train2.csv")
...
test_df = describe_dataset("test2.csv")
...
print(pd.DataFrame(testset_final_results, columns=["Model", "Precision Score", "Accuracy score", "Recall Score", "F1 score", "Confusion Matrix"]))
...
with open("./model/DTC_model.pkl", "wb") as f:
